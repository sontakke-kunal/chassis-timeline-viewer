...
class RoutesPainterWidget extends ConsumerWidget {
  final MapVariables mapVariables;
  const RoutesPainterWidget({super.key, required this.mapVariables});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final canvasPaintWatch = ref.watch(mapPainterController);
    return CustomPaint(
      painter: canvasPaintWatch.routesPainterCanvas,
